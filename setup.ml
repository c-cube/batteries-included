...
(* OASIS_START *)
(* DO NOT EDIT (digest: 798c9ee7dfb00f276c890588c144a389) *)
(*
...
let setup_t =
  {
       ...
       [
          ("main",
            CustomPlugin.Test.main
              {
                 CustomPlugin.cmd_main =
                   [(OASISExpr.EBool true, ("$make", ["test"]))];
                 cmd_clean = [(OASISExpr.EBool true, None)];
                 cmd_distclean = [(OASISExpr.EBool true, None)]
              })
       ];
            ...
            [
               Flag
                 ({
                   ...
                   {
                      flag_description = Some "Enable Lwt support";
     ...
     oasis_version = "0.4.1";
     oasis_digest =
       Some "\203\135\173\199x\227\0242\165\201\190U\188 \016\154";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
