...
(* OASIS_START *)
(* DO NOT EDIT (digest: e6054e52fd3bca5b37acc678a712d3e6) *)
(*
...
let setup_t =
  {
            ...
            CustomPlugin.Test.main
              {
                 CustomPlugin.cmd_main =
                   [(OASISExpr.EBool true, ("make", ["test-native"]))];
     ...
     package =
       {
          ...
          homepage = Some "http://batteries.forge.ocamlcore.org/";
          ...
          build_custom =
            {
               pre_command =
                 [(OASISExpr.EBool true, Some (("make", ["prefilter"])))];
               post_command = [(OASISExpr.EBool true, None)]
            };
          ...
          files_ab = ["src/batteriesConfig.ml.ab"];
          sections =
            [
               Flag
                 ({
                   ...
                   {
                      flag_description =
                        Some "Build and install arbitrary precision numbers";
               ...
               Flag
                 ({
                   ...
                   {
                      flag_description =
                        Some "Build and install threading facilities";
                      flag_default = [(OASISExpr.EBool true, true)]
                   });
               Flag
                 ({
                   ...
                   {
                      flag_description =
                        Some "Build and install unix compatibility layer";
                      flag_default = [(OASISExpr.EBool true, true)]
                   });
               Flag
                 ({
                   ...
                   {
                      flag_description =
                        Some "Build and install Bigarray interface";
                      flag_default = [(OASISExpr.EBool true, true)]
                   });
               Flag
                 ({
               ...
               Library
                 ({
                   ...
                   },
                   {
                      ...
                      lib_findlib_parent = Some "batteries";
                      lib_findlib_name = Some "core";
                      lib_findlib_containers = []
                   });
               Library
                 ({
                     cs_name = "batteries_bigarray";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           InternalLibrary "batteries_core";
                 ...
                 ({
                  ...
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           InternalLibrary "batteries_core";
                           InternalLibrary "batteries_bigarray";
                   ...
                   {
                      lib_modules =
                        ["BatUnix"; "BatLogger"; "BatLog"; "BatFile"];
                      lib_pack = false;
                      lib_internal_modules = [];
                      lib_findlib_parent = Some "batteries";
               ...
               Library
                 ({
                   ...
                   {
                      lib_modules = ["BatNum"; "BatBig_int"];
                      lib_pack = false;
                      lib_internal_modules = [];
                      lib_findlib_parent = Some "batteries";
                      lib_findlib_name = Some "num";
                      lib_findlib_containers = []
                   });
               Library
                 ({
                     cs_name = "batteries_thread";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                   ...
                   {
                      lib_modules = ["BatRMutex"; "BatMutex"];
                      lib_pack = false;
                      lib_internal_modules = [];
                      lib_findlib_parent = Some "batteries";
                  ...
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           InternalLibrary "batteries_core";
                           InternalLibrary "batteries_bigarray";
                           InternalLibrary "batteries_unix";
                           FindlibPackage ("num", None);
               ...
               Doc
                 ({
                  ...
                  },
                   {
                      ...
                      doc_title = "Ocaml Batteries Documentation";
                      doc_authors = [];
                      doc_abstract = None;
                      doc_format = OtherDoc;
                      doc_data_files = [];
               ...
               SrcRepo
                 ({
                  ...
                  },
                   {
                      src_repo_type = Git;
                      src_repo_location =
                        "git://github.com/ocaml-batteries-team/batteries-included.git";
                      src_repo_browser =
                        Some
     ...
     oasis_version = "0.4.4";
     oasis_digest = Some "\240\193\216Y\024\190\184\000Y\201<\129O\173\0302";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
